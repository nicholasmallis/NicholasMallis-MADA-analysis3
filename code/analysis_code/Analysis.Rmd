...
#saved it as a file
summarytable_file2 = here("results", "lm_fit_table.rds")
...
#saved it as a file
summarytable_file3 = here("results", "lm_fit_stats.rds")
...
resulttable=readRDS("../../results/lm_fit_stats.rds")
...
#saved it as a file
summarytable_file4 = here("results", "lm_fit_full_table.rds")
...
#saved it as a file
summarytable_file5 = here("results", "lm_fit_full_stats.rds")
...
resulttable=readRDS("../../results/lm_fit_full_table.rds")
...
resulttable=readRDS("../../results/lm_fit_full_stats.rds")
...
Here I use ANOVA to test whether the more complex model is significantly better at capturing the data than the simpler model. The resulting p-value is sufficiently low so we conclude that the more complex model is significantly better than the simpler model.

```{r}

comparing_lm_anova <- anova(lm_fit$fit, lm_fit2$fit)

summarytable_file6 = here("results", "comparing_lm_anova.rds")
...
resulttable=readRDS("../../results/comparing_lm_anova.rds")
...
summarytable_file7 = here("results", "log_fit_table.rds")
...
#saving
summarytable_file8 = here("results", "log_fit_stats.rds")
...
resulttable=readRDS("../../results/log_fit_table.rds")
...
resulttable=readRDS("../../results/log_fit_stats.rds")
knitr::kable(resulttable, caption = 'Simple Logistic Model with Runny Nose as the Predictor and Nausea as the Outcome')
```
...
summarytable_file9 = here("results", "log_fit_full_table.rds")
saveRDS(log_fit_full_table, file = summarytable_file9)

log_fit_full_stats <- glance(log_fit2)

summarytable_file10 = here("results", "log_fit_full_stats.rds")
...
resulttable=readRDS("../../results/log_fit_full_table.rds")
...
resulttable=readRDS("../../results/log_fit_full_stats.rds")
knitr::kable(resulttable, caption = 'Multivariate Logistic Model with Runny Nose and other Covariates as the Predictors and Nausea as the Outcome')
```


#Comparing both logistic models:
Due to the high scaled deviance 189.73, we conclude that the model with all predictors is significantly better at capturing the data than the simpler model
```{r}
#using anova to compare both the complex and simple
anova_log <- anova(log_fit$fit, log_fit2$fit)

#saving as table
summarytable_file11 = here("results", "anova_log.rds")
...
resulttable=readRDS("../../results/anova_log.rds")
