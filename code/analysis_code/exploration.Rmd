...
table1 <- table1(~ Nausea + BodyTemp + RunnyNose + SwollenLymphNodes + ChestCongestion + Weakness +  NasalCongestion + CoughYN + Sneeze + Fatigue + SubjectiveFever + Headache , data=mydata, overall="Total")
